...
public static FlatDBHelper getInstanse(Context ctx){
    ...
    public void saveNewFlat(String name, String address, String dev,double area,double storage, int rooms, int floor,
                            int balcony, int parking, int equip,int garden,String minUrl,String maxUrl, String planUrl, String galleryUrl, String galleryUrl2) {
    ...
    public void addSomeFlats(){
        saveNewFlat("Nowe Żerniki","Wrocław, Nowe Żerniki","ATAL",45.5,3.0, 3,2,0,0,1,0,
        ...
        saveNewFlat("Nowe Miasto Różanka","Wrocław, Obornicka","ATAL",25.0,5.0, 1,3,1,1,0,1,
        ...
        saveNewFlat("Browary Wrocławskie","Wrocław, Jedności Narodowej","ARCHICOM",57.0,2.0,3,0,1,1,1,1,
        ...
        saveNewFlat("Olimpia Port","Wrocław, Ferdynanda Magellana","ARCHICOM",35.5,1.0,2,2,0,1,0,1,
        ...
        saveNewFlat("River Point","Wrocław, Mieszczańska","ARCHICOM",45.5,2.5,3,0,0,1,1,1,
        ...
        saveNewFlat("Promenady Wrocławskie","Wrocław, Zakładowa","VANTAGE",25.5,1.0,1,5,1,1,0,1,
        ...
        saveNewFlat("LogIn City","Wrocław, Grabiszyńska","VANTAGE",61.0,5.0,3,4,1,1,1,1,
        ...
        saveNewFlat("Di Trevi","Wrocław, Armii Krajowej","LOKUM",45.0,2.0,3,2,1,0,0,1,
        ...
        saveNewFlat("Primera","Wrocław, Gagarina","PCG",50.0,5.0,3,4,0,1,1,1,
